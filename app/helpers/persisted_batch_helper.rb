...
module PersistedBatchHelper 
  ...
  def batch_edit_tools
    render :partial=>'/persisted_batch/tools'
  end
  ...
  def batch_edit_continue(label = 'Update Selected') 
    render :partial => '/persisted_batch/next_page', :locals=>{:label=>label} 
  end
  ...
  def batch_edit_select(document)
    render :partial=>'/persisted_batch/add_button', :locals=>{:document=>document}
  end
  ...
  def batch_check_all(label = 'Use all results')
    render :partial=>'/persisted_batch/check_all', :locals=>{:label=>label}
  end
  ...
  def batch_edit_delete_batch(label = 'Delete Selected', confirm = 'Are you sure?') 
    render :partial => '/persisted_batch/delete_batch', :locals=>{:label=>label, :confirm=>confirm} 
  end
end
